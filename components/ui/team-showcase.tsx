...
export default function TeamShowcase({ members = DEFAULT_MEMBERS }: TeamShowcaseProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center align-middle gap-8 md:gap-10 lg:gap-14 select-none w-full max-w-5xl mx-auto py-8 px-4 md:px-6 font-sans">
      {/* ── Left: photo grid ── */}
